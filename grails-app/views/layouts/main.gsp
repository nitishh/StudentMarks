...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="shortcut icon" href="${resource(dir: 'images', file: 'school_logo.png')}" type="image/x-icon">
                ...
                <div class="nav">
                    <div>
                        <ul>
                            ...
                            <li class="dropdown"><g:link controller="marksheet" action="index">Mark</g:link></li>

			...
			<ol class="property-list marksheet">
				...
				<li class="fieldcontain">
					<span id="sj-label" class="property-label"><g:message code="marksheet.sj.label" default="Sj" /></span>
						...
						<span class="property-value" aria-labelledby="sj-label"><g:link controller="subject" action="show" id="${marksheetInstance?.sj?.id}">${marksheetInstance?.sj?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="st-label" class="property-label"><g:message code="marksheet.st.label" default="St" /></span>
						...
						<span class="property-value" aria-labelledby="st-label"><g:link controller="student" action="show" id="${marksheetInstance?.st?.id}">${marksheetInstance?.st?.encodeAsHTML()}</g:link></span>
